...
from templates.fair_result import FairResultTemplate


class FairOddsCalculator(QWidget):
    ...
    def create_ui(self):
        ...
        title = QLabel("Fair Odds Calculator")
        ...
        self.calculate_button.clicked.connect(self.calculate_fair_odds)
    ...
    def calculate_fair_odds(self):
        ...
        result = FairOddsCalculatorEngine.calculate_fair_odds(odds)
    ...
    def show_result(self, result):
        ...
        html = FairResultTemplate.build(result, labels)
